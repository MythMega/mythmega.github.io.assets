...
INPUT_JSON = "totk_food.json"
OUTPUT_DIR = "./assets/category/zelda/totk/Food/"
LOG_FILE = "result_food.log"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        for item in items:
            ...
            # Update JSON
            item["PictureMain"] = f"./assets/category/zelda/totk/Food/{name_clean}.png"
    ...
    with open("totk_food_updated.json", "w", encoding="utf-8") as f:
        json.dump(data, f, ensure_ascii=False, indent=2)

    print("\nDone! Check result_food.log and the Food folder.")
